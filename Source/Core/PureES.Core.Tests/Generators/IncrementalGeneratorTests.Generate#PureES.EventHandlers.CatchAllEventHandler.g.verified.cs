//HintName: PureES.EventHandlers.CatchAllEventHandler.g.cs
// <auto-generated/>
...
namespace PureES.EventHandlers
{
    ...
    internal class CatchAllEventHandler : global::PureES.Core.IEventHandler
    {
        private readonly global::Microsoft.Extensions.Logging.ILogger<CatchAllEventHandler> _logger;
        private readonly global::PureES.Core.PureESEventHandlerOptions _options;

        public CatchAllEventHandler(
            global::Microsoft.Extensions.Options.IOptions<global::PureES.Core.PureESOptions> options,
            global::Microsoft.Extensions.Logging.ILogger<CatchAllEventHandler> logger = null)
        {
            this._options = options?.Value.EventHandlers ?? throw new ArgumentNullException(nameof(options));
            this._logger = logger ?? global::Microsoft.Extensions.Logging.Abstractions.NullLogger<CatchAllEventHandler>.Instance;
        }
        ...
        public global::System.Threading.Tasks.Task Handle(global::PureES.Core.EventEnvelope @event)
        {
            using (var activity = new global::System.Diagnostics.Activity("PureES.EventHandlers.EventHandler"))
            {
                ...
                activity.Start();
                PureESCoreTestsModelsTestEventHandlers_CatchAll(@event);
        ...
        [global::System.Diagnostics.DebuggerStepThroughAttribute()]
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        // CatchAll on PureES.Core.Tests.Models.TestEventHandlers
        private void PureESCoreTestsModelsTestEventHandlers_CatchAll(global::PureES.Core.EventEnvelope @event)
        {
            ...
            global::System.Type eventType = null;
                ...
                }))
            {
                ...
                try
                {
                    this._logger?.Log(
                        ...
                        "CatchAll",
                        parentType);
                    global::PureES.Core.Tests.Models.TestEventHandlers.CatchAll(@event);
