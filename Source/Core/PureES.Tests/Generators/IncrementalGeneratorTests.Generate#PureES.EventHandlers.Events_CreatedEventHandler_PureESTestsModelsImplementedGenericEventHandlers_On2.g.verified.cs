...
namespace PureES.EventHandlers
{
    ...
    internal class Events_CreatedEventHandler_PureESTestsModelsImplementedGenericEventHandlers_On2 : global::PureES.IEventHandler<global::PureES.Tests.Models.Events.Created>
    {
        ...
        public Task Handle(global::PureES.EventEnvelope @event)
        {
            ...
            using (var activity = PureES.PureESTracing.ActivitySource.StartActivity("HandleEvent"))
            {
                if (activity != null)
                {
                    activity.DisplayName = "PureES.Tests.Models.ImplementedGenericEventHandlers.On2";
