//HintName: PureES.CommandHandlers.intArrayCommandHandler.g.cs
// <auto-generated/>
...
namespace PureES.CommandHandlers
{
    ...
    internal sealed class intArrayCommandHandler : global::PureES.ICommandHandler<int[]>
    {
        private readonly PureES.ICommandStreamId<int[]> _getStreamId;
        ...
        private readonly global::System.Collections.Generic.IEnumerable<global::PureES.ICommandValidator<int[]>> _syncValidators;
        private readonly global::System.Collections.Generic.IEnumerable<global::PureES.IAsyncCommandValidator<int[]>> _asyncValidators;
        private readonly global::Microsoft.Extensions.Logging.ILogger<intArrayCommandHandler> _logger;
        private readonly global::Microsoft.Extensions.Logging.ILoggerFactory _service0;

        [global::System.ComponentModel.EditorBrowsableAttribute(global::System.ComponentModel.EditorBrowsableState.Never)]
        [global::System.Diagnostics.DebuggerStepThroughAttribute()]
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        public intArrayCommandHandler(
            global::Microsoft.Extensions.Logging.ILoggerFactory service0,
            PureES.ICommandStreamId<int[]> getStreamId,
            ...
            global::System.Collections.Generic.IEnumerable<global::PureES.ICommandValidator<int[]>> syncValidators,
            global::System.Collections.Generic.IEnumerable<global::PureES.IAsyncCommandValidator<int[]>> asyncValidators,
            global::PureES.IConcurrency concurrency = null,
            global::Microsoft.Extensions.Logging.ILogger<intArrayCommandHandler> logger = null)
        {
            ...
            this._logger = logger ?? global::Microsoft.Extensions.Logging.Abstractions.NullLogger<intArrayCommandHandler>.Instance;
        ...
        [global::System.Diagnostics.DebuggerStepThroughAttribute()]
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        public string GetStreamId(int[] command)
        {
            if (command == null)
            {
        ...
        private static readonly global::System.Type CommandType = typeof(int[]);

        [global::System.ComponentModel.EditorBrowsableAttribute(global::System.ComponentModel.EditorBrowsableState.Never)]
        [global::System.Diagnostics.DebuggerStepThroughAttribute()]
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        public async global::System.Threading.Tasks.Task<uint> Handle(int[] command, CancellationToken cancellationToken)
        {
            ...
            using (var activity = PureES.PureESTracing.ActivitySource.StartActivity("HandleCommand"))
            {
                if (activity != null)
                {
                    ...
                    if (activity.IsAllDataRequested)
                    {
                        ...
                        activity?.SetTag("Method", "CreateOnAsyncEnumerable");
                    }
                }
                using (_logger.BeginScope(new global::System.Collections.Generic.Dictionary<string, object>()
                    {
                        ...
                        { "Method", "CreateOnAsyncEnumerable" },
                    }))
                {
                    ...
                    try
                    {
                        ...
                        var result = global::PureES.Tests.Models.TestAggregate.CreateOnAsyncEnumerable(command, this._service0);
