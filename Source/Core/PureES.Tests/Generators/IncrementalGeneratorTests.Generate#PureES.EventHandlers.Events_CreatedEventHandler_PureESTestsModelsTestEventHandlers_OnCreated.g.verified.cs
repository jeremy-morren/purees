//HintName: PureES.EventHandlers.Events_CreatedEventHandler_PureESTestsModelsTestEventHandlers_OnCreated.g.cs
// <auto-generated/>
...
namespace PureES.EventHandlers
{
    ...
    internal class Events_CreatedEventHandler_PureESTestsModelsTestEventHandlers_OnCreated : global::PureES.IEventHandler<PureES.Tests.Models.Events.Created>
    {
        private readonly global::Microsoft.Extensions.Logging.ILogger<Events_CreatedEventHandler_PureESTestsModelsTestEventHandlers_OnCreated> _logger;
        ...
        public Events_CreatedEventHandler_PureESTestsModelsTestEventHandlers_OnCreated(
            ...
            global::Microsoft.Extensions.Logging.ILogger<Events_CreatedEventHandler_PureESTestsModelsTestEventHandlers_OnCreated> logger = null)
        {
            this._options = options?.Value.EventHandlers ?? throw new ArgumentNullException(nameof(options));
            this._logger = logger ?? global::Microsoft.Extensions.Logging.Abstractions.NullLogger<Events_CreatedEventHandler_PureESTestsModelsTestEventHandlers_OnCreated>.Instance;
        ...
        public async global::System.Threading.Tasks.Task Handle(global::PureES.EventEnvelope @event)
        {
            ...
            using (var activity = PureES.PureESTracing.ActivitySource.StartActivity("HandleEvent"))
            {
                if (activity != null)
                {
                    activity.DisplayName = "HandleEvent TestEventHandlers.OnCreated (Events+Created)";
                    ...
                    try
                    {
                        ...
                        if (this._options.AsyncRetryPolicy != null)
                        {
                            await this._options.AsyncRetryPolicy.ExecuteAsync(() => 
                                global::PureES.Tests.Models.TestEventHandlers.OnCreated(
