...
namespace PureES.CommandHandlers
{
    ...
    internal sealed class Commands_UpdateCommandHandler : global::PureES.ICommandHandler<global::PureES.Tests.Models.Commands.Update>
    {
        ...
        [global::System.Diagnostics.DebuggerStepThroughAttribute()]
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        public string GetStreamId(global::PureES.Tests.Models.Commands.Update command)
        {
            if (command == null)
            {
        ...
        public async global::System.Threading.Tasks.Task<uint> Handle(global::PureES.Tests.Models.Commands.Update command, CancellationToken cancellationToken)
        {
            ...
            using (var activity = PureES.PureESTracing.ActivitySource.StartActivity("HandleCommand"))
            {
                if (activity != null)
                {
                    activity.DisplayName = "HandleCommand TestAggregate.UpdateOn";
                    if (activity.IsAllDataRequested)
                    {
                        activity?.SetTag("Command", CommandType);
                        activity?.SetTag("Aggregate", AggregateType);
                        activity?.SetTag("Method", "UpdateOn");
                    }
                }
