...
namespace PureES.EventHandlers
{
    ...
    internal class Events_UpdatedEventHandler_PureESTestsModelsTestEventHandlers_OnUpdated : global::PureES.IEventHandler<PureES.Tests.Models.Events.Updated>
    {
        ...
        public global::System.Threading.Tasks.Task Handle(global::PureES.EventEnvelope @event)
        {
            ...
            using (var activity = PureES.PureESTracing.ActivitySource.StartActivity("HandleEvent"))
            {
                if (activity != null)
                {
                    activity.DisplayName = "HandleEvent TestEventHandlers.OnUpdated (Events+Updated)";
